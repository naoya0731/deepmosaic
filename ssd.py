...
def SSD300(input_shape, num_classes=21):
    ...
    net['conv1_1'] = Conv2D(64, (3, 3),
                                   activation='relu',
                                   name='conv1_1',
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['input'])
    net['conv1_2'] = Conv2D(64, (3, 3),
                                   activation='relu',
                                   name='conv1_2',
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['conv1_1'])
    ...
    net['conv2_1'] = Conv2D(128, (3, 3),
                                   activation='relu',
                                   padding='same',
                                   name='conv2_1', kernel_regularizer=regularizers.l1(0.01))(net['pool1'])
    net['conv2_2'] = Conv2D(128, (3, 3),
                                   activation='relu',
                                   name='conv2_2', 
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['conv2_1'])
    net['po.l1'] = MaxPooling2D((2, 2), strides=(2, 2), padding='same',
                                name='po.l1')(net['conv2_2'])
    # Block 3
    net['conv3_1'] = Conv2D(256, (3, 3),
                                   activation='relu',
                                   name='conv3_1',
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['po.l1'])
    net['conv3_2'] = Conv2D(256, (3, 3),
                                   activation='relu',
                                   name='conv3_2',
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['conv3_1'])
    net['conv3_3'] = Conv2D(256, (3, 3),
                                   activation='relu',
                                   name='conv3_3',
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['conv3_2'])
    ...
    net['conv4_1'] = Conv2D(512, (3, 3),
                                   activation='relu',
                                   name='conv4_1',
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['pool3'])
    net['conv4_2'] = Conv2D(512, (3, 3),
                                   activation='relu',
                                   name='conv4_2',
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['conv4_1'])
    net['conv4_3'] = Conv2D(512, (3, 3),
                                   activation='relu',
                                   name='conv4_3',
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['conv4_2'])
    ...
    net['conv5_1'] = Conv2D(512, (3, 3),
                                   activation='relu',
                                   name='conv5_1',
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['pool4'])
    net['conv5_2'] = Conv2D(512, (3, 3),
                                   activation='relu',
                                   name='conv5_2',
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['conv5_1'])
    net['conv5_3'] = Conv2D(512, (3, 3),
                                   activation='relu',
                                   name='conv5_3',
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['conv5_2'])
    net['pool5'] = MaxPooling2D((3, 3), strides=(1, 1), padding='same',
                                name='pool5')(net['conv5_3'])
    # FC6
    net['fc6'] = AtrousConvolution2D(1024, (3, 3), atrous_rate=(6, 6),
                                     activation='relu', padding='same',
                                     name='fc6', kernel_regularizer=regularizers.l1(0.01))(net['pool5'])
    x = Dropout(0.5, name='drop6')(net['fc6'])
    net['drop6'] = x
    # FC7
    net['fc7'] = Conv2D(1024, (1, 1), activation='relu',
                               name='fc7', padding='same', kernel_regularizer=regularizers.l1(0.01))(net['drop6'])
    x = Dropout(0.5, name='drop7')(net['fc7'])
    net['drop7'] = x
    # Block 6
    net['conv6_1'] = Conv2D(256, (1, 1), activation='relu',
                                   name='conv6_1', 
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['drop7'])
    net['conv6_2'] = Conv2D(512, (3, 3), subsample=(2, 2),
                                   activation='relu', name='conv6_2',
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['conv6_1'])
    # Block 7
    net['conv7_1'] = Conv2D(128, (1, 1), activation='relu',
                                   name='conv7_1', 
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['conv6_2'])
    net['conv7_2'] = ZeroPadding2D()(net['conv7_1'])
    net['conv7_2'] = Conv2D(256, (3, 3), subsample=(2, 2),
                                   activation='relu', name='conv7_2',
                                   padding='valid', kernel_regularizer=regularizers.l1(0.01))(net['conv7_2'])
    # Block 8
    net['conv8_1'] = Conv2D(128, (1, 1), activation='relu',
                                   name='conv8_1',
                                   padding='same', kernel_regularizer=regularizers.l1(0.01))(net['conv7_2'])
    ...
    x = Conv2D(num_priors * 4, (3, 3), name='conv4_3_norm_mbox_loc',
                        padding='same', kernel_regularizer=regularizers.l1(0.01))(net['conv4_3_norm'])
    ...
    net['fc7_mbox_loc'] = Conv2D(num_priors * 4, (3, 3),
                                        name='fc7_mbox_loc', 
                                        padding='same', kernel_regularizer=regularizers.l1(0.01))(net['fc7'])
    ...
    x = Conv2D(num_priors * 4, (3, 3), name='conv8_2_mbox_loc',
                      padding='same', kernel_regularizer=regularizers.l1(0.01))(net['conv8_2'])
